            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('uchanges.store') }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="employee_id" value="{{$employee_id}}">

                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">اسم الإضافة/الحسمية</label>
                            ...
                            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }} radio">
                                ...
                                <div class="col-md-6  col-md-offset-4">
                                    <div class="row">
                                        ...
                                        <label dir="ltr" class="col-xs-4"><input id="type" type="radio" class="" name="type" value="1" required > حسمية </label><br/>
                                    </div>
                                    @if ($errors->has('type'))
                                        <span class="help-block">
